...
var action =true;
  class   AddBookForm extends Component {
    constructor(props) {
        ...
        this.validateAddFields = this.validateAddFields.bind(this);
        this.validateEditFields = this.validateEditFields.bind(this);
    }
    ...
    callModalWithValues({ id, title, author, image, date }) {
        this.setState({
            ...
            date,
            open: true,
            dialogTitle: !this.props.isediting ? "Add a Book" : "Edit Book",
            dialogButton:! this.props.isediting ? "Add" : "Edit"
        });
    }
    ...
    handleSubmit() {
        if (!this.props.isediting && this.validateAddFields() && !this.state.isTitleExist ) {
        ...
        if (this.props.isediting && this.validateEditFields(this.state) && !this.state.isTitleExist ) {
    ...
    validateEditFields({ id, title, author, image, date }) {
        const isTitleExist = this.props.books.find(
            book => book.title === formatTitle(title)
        );
        if (
    ...
    render() {
        const { book, classes, isediting, btntext } = this.props;
        ...
        return (
                ...
                <React.Fragment>
                    ...
                    <Button onClick={!isediting? this.callModalWithValues  : () => this.callModalWithValues(book)} color="inherit">
                        {btntext}
                    </Button>
